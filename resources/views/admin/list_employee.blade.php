                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr class="unread">
                            ...
                            <td>
                                <h6 class="mb-1"><a href="{{asset('admin/detail-employee')}}">Isabella Christensen</a></h6>
                            </td>
                            <td>
                                <h6 class="text-muted"><i class="fas fa-circle text-c-red f-10 m-r-15"></i>HCM street</h6>
                            </td>
                            <td>
                            ...
                            <td><a href="#!" class="label theme-bg2 text-white f-12">Delete</a><a href="{{asset('/admin/edit-employee')}}" class="label theme-bg text-white f-12">Edit</a></td>
                        </tr>
                        <tr class="unread">
                            <td>1</td>
                            <td><img class="rounded-circle" style="width:40px;" src="{{asset('images/user/avatar-1.jpg')}}" alt="activity-user"></td>
