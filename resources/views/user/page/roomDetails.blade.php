...
@section('content')
    ...
    <section class="ftco-section ftco-bg">
      <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                        ...
                        <p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then she continued her way.</p>
                        <a class="btn btn-book-now" href="{{ route('bookings.index') }}">Book Now <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                    <div class="col-md-12 room-single ftco-animate mb-5 mt-4">
                        ...
                        <figure>
                            ...
                            <a href="https://vimeo.com/45830194" class="play-button popup-vimeo"><span class="fa fa-play"></span></a>
                        </figure>
                        </div>
                    </div>
                                ...
                                <form method="post" class="star-rating">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleCheck1">
                                            <p class="rate"><span><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> 100 Ratings</span></p>
                                        </label>
                                    </div>
                                        <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">
                                            <p class="rate"><span><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i> 30 Ratings</span></p>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">
                                            <p class="rate"><span><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i> 5 Ratings</span></p>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
                            ...
                            <div class="col-sm col-md-6 ftco-animate">
                                <div class="room">
                                    ...
                                    <div class="text p-3 text-center">
                                        ...
                                        <hr>
                                        <p class="pt-1"><a href="room-single.html" class="btn-custom">View Room Details <span class="fa fa-long-arrow-right"></span></a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm col-md-6 ftco-animate">
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="meta">
                            <div><a href="#"><span class="fa fa-calendar"></span> July 12, 2018</a></div>
                ...
                <div class="sidebar-box ftco-animate ftco-text">
                    <h3>Paragraph</h3>
