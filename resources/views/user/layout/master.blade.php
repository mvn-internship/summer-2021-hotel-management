...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section ftc-no-pb ftc-no-pt ftco-bg">
			<div class="container">
				<div class="row">
        ...
        <div class="row d-flex">
            ...
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
              		<img src="images/reception-bell.svg" alt="" class="image-services">
              	</div>
              </div>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
				  <img src="images/serving-dish.svg" alt="" class="image-services">
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
          ...
          <div class="col-md-3 d-flex align-sel Searchf-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
				  <img src="images/car.svg" alt="" class="image-services">
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
              	<div class="icon d-flex align-items-center justify-content-center">
				  <img src="images/spa.svg" alt="" class="image-services">
              	</div>
              </div>
              <div class="media-body p-2 mt-2">
    			...
    			<div class="col-md-10">
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="50000">50,000</strong>
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="3000">3,000</strong>
		                <span>Rooms</span>
		              </div>
		            </div>
		          </div>
            ...
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3 d-block">
                ...
                <div class="meta mb-3">
                  ...
                  <div><a href="#" class="fa fa-commenting"><span class="icon-chat"></span> 3</a></div>
                </div>
              </div>
            </div>
          </div>
