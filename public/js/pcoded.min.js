...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://codedthemes.com/item/datta-able-premium/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-arrow-up" aria-hidden="true"></i>' +
    '</a> ' + '</div>' + '');
var $window = $(window);
